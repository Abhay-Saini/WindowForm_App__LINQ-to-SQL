...
namespace WindowForm_App
{
    ...
    partial void DeleteStudent(Student instance);
		...
		public StudentDBDataContext() : 
				base(global::WindowForm_App.Properties.Settings.Default.StudentDBConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnStundardChanging(string value);
    partial void OnStundardChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Stundard", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string Stundard
		{
			get
			{
				return this._Stundard;
			}
			set
			{
				if ((this._Stundard != value))
				{
					this.OnStundardChanging(value);
					this.SendPropertyChanging();
					this._Stundard = value;
					this.SendPropertyChanged("Stundard");
					this.OnStundardChanged();
				}
			}
		}
